...
DEMO_IMAGE= r"C:\Users\saksh\OneDrive\Desktop\Human_Pose_Estimation_using_AIML_GithubRepository\stand.jpg"
...
net= cv2.dnn.readNetFromTensorflow(r"C:\Users\saksh\OneDrive\Desktop\Python Programs\graph_opt.pb")


st.title("Human Pose Estimation OpenCV")

st.text("Make sure you have an image with all the parts clearly visible")

image_file_buffer= st.file_uploader("Upload an image, Make sure you have a clear image", type=["jpg", "jpeg", "png"])
...
def poseDetector(frame):
  ...
  for pair in POSE_PAIRS:
    ...
    if points[idFrom] and points[idTo]:
      ...
      cv2.ellipse(frame, points[idFrom], (3,3), 0,0, 360, (0,255,0), cv2.FILLED)
      cv2.ellipse(frame, points[idTo], (3,3), 0,0, 360, (0,255,0), cv2.FILLED)
